...
@WebServlet ("/saveTodolistGroup")

public class SaveTodolistGroupServlet extends HttpServlet{
	...
	protected void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		String todolistName = request.getParameter("todolist");
		...
		response.setContentType("text/plain");
		        ...
		        if (parameterNames.hasMoreElements()) {
		            ...
		            while (parameterNames.hasMoreElements()){
								        ...
								        if (num == 2){
								        	ToDoListDB.saveToDoListNameGroup (name,todolistName,time [0], event [0],day [0],month [0], year [0],true);
								        }
								        else{
								        	
								        
								        	ToDoListDB.saveToDoListNameGroup (name,todolistName,time [0], event [0],day[0],month [0], year [0],false);
								        }
					            	}
			            		}
