...
<title>Welcome <%=request.getParameter("group")%></title>
<script  src="jquery-3.2.1.min.js"></script>
<script type="text/javascript">
function saveValue() {
	
	$.ajax({
		url: "saveCalendarGroup",
		type: 'POST',
		dataType: 'json',
...
<input type = hidden value = "<%=request.getParameter("group")%>" id = group name = group>
<input type = hidden value = "<%=request.getParameter("add")%>" id = calendarName name = calendarName>
